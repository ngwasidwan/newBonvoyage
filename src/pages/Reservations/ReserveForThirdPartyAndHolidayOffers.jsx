...
import { useThirdPartyAndHolidaysOffers } from "../../lib/UrlCustomHook";
import RideShareReservationAndMoreContain from "../Business/RideShareReservationAndMoreContain";

const ReserveForThirdPartyAndHolidayOffers = () => {
  const { holidayOffers, thirdPartyReservation } =
    useThirdPartyAndHolidaysOffers();
    ...
    <div>
      ...
      {thirdPartyReservation && (
        <div>
          {" "}
          <SingleTextImageView image="url(/help.jpg)">
            <h1> for third Party reservation</h1>
          </SingleTextImageView>{" "}
          {/* //todo Rent to own Contain */}
          <RideShareReservationAndMoreContain
            h3="How for third Party reservation Works"
            p1="No matter if you are a traveler looking to explore the city or a
            local needing a temporary vehicle. You may find numerous commuting
            options with bonevoyage, Below are some of the highly-rated car"
            p2="Bon Voyage is the first on the list of the best car rental
...
export default ReserveForThirdPartyAndHolidayOffers;
